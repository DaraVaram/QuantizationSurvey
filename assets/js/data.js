...
deploymentStack: [
  {family:"ARM-Based",
   ...
   impl:"Most reproducible baseline for modest-depth sensing workloads: HAR, environmental monitoring, speech and keyword spotting, networking, spectrum sensing, and lightweight vision or healthcare (Section 6.1, Table 4). Choose when mature tooling, portability, and low-friction integration matter more than peak efficiency."},
  {family:"RISC-V-Based",
   ...
   impl:"Feasible healthcare, industrial-monitoring, and robotics deployments in the lower-to-middle tier of edge workloads, with a smaller and more recent application base than ARM (Section 6.2, Table 5). Choose when an open-ISA, low-cost part suffices for compact workloads and a younger toolchain is acceptable."},
